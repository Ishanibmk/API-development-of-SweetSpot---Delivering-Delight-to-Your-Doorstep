...
def schedule_email(send_time,subject, message, recipient_list):
        ...
        scheduler.enter(delay, 1, send_mail, argument=(subject, message, 'ishanibmk124@gmail.com', recipient_list))
...
class OrderViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request):
        ...
        if payment_method:
            ...
            print(recipient)
            try:
                send_mail(subject, message, 'ishanibmk124@gmail.com', [recipient])
    ...
    def  delivery_tracking(self,request,id):
        ...
        sweetspot_location= "Garia, West Bengal,India"
