...
class CustomUserManager(BaseUserManager):
    ...
    def create_superuser(self, email, phone_no, first_name, last_name, city, state, address, pincode, password, **extra_fields):
        ...
        return self.create_user(email, phone_no, first_name, last_name, city, state, address, pincode, password, **extra_fields)
